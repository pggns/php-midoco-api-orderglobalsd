...
class GetMidocoAttributeDefinitionResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoSystemAttributeDefinition[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoSystemAttributeDefinition[]
     */
    ...
    public static function validateMidocoSystemAttributeDefinitionForArrayConstraintFromSetMidocoSystemAttributeDefinition(?array $values = []): string
    {
        ...
        foreach ($values as $getMidocoAttributeDefinitionResponseMidocoSystemAttributeDefinitionItem) {
            ...
            if (!$getMidocoAttributeDefinitionResponseMidocoSystemAttributeDefinitionItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoSystemAttributeDefinition) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoSystemAttributeDefinition property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoSystemAttributeDefinition, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoSystemAttributeDefinition $item
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetMidocoAttributeDefinitionResponse
     */
    public function addToMidocoSystemAttributeDefinition(\Pggns\MidocoApi\OrderglobalSD\StructType\MidocoSystemAttributeDefinition $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoSystemAttributeDefinition) {
            throw new InvalidArgumentException(sprintf('The MidocoSystemAttributeDefinition property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoSystemAttributeDefinition, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
