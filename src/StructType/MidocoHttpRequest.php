...
class MidocoHttpRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpHeader[]
     */
     ...
     * @var \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpParameter[]
     */
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpHeader[] $midocoHttpHeader
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpParameter[] $midocoHttpParameter
     ...
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpHeader[]
     */
    ...
    public static function validateMidocoHttpHeaderForArrayConstraintFromSetMidocoHttpHeader(?array $values = []): string
    {
        ...
        foreach ($values as $midocoHttpRequestMidocoHttpHeaderItem) {
            ...
            if (!$midocoHttpRequestMidocoHttpHeaderItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpHeader) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoHttpHeader property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpHeader, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpHeader[] $midocoHttpHeader
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpRequest
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpHeader $item
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpRequest
     */
    public function addToMidocoHttpHeader(\Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpHeader $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpHeader) {
            throw new InvalidArgumentException(sprintf('The MidocoHttpHeader property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpHeader, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpParameter[]
     */
    ...
    public static function validateMidocoHttpParameterForArrayConstraintFromSetMidocoHttpParameter(?array $values = []): string
    {
        ...
        foreach ($values as $midocoHttpRequestMidocoHttpParameterItem) {
            // validation for constraint: itemType
            if (!$midocoHttpRequestMidocoHttpParameterItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpParameter) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoHttpParameter property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpParameter, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpParameter $item
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpRequest
     */
    public function addToMidocoHttpParameter(\Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpParameter $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpParameter) {
            throw new InvalidArgumentException(sprintf('The MidocoHttpParameter property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoHttpParameter, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
